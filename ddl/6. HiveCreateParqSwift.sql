...
create database parq_swift;
use  parq_swift; 
set hdfsDataPath= swift://tpcds-parq.bdcstorage;
set fieldDelimiter=|;
...
set reviewsTableName=product_reviews;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:customerDemographicsTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:customerDemographicsTableName}'
...
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:dateTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:dateTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:warehouseTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:warehouseTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:shipModeTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:shipModeTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:timeTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:timeTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:reasonTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:reasonTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:incomeTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:incomeTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:storeTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:storeTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:webSiteTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:webSiteTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:householdDemographicsTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:householdDemographicsTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:webPageTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:webPageTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:promotionTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:promotionTableName}'
 --distribute by replication;
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:customerTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:customerTableName}'
 ...
 CREATE EXTERNAL TABLE ${hiveconf:customerAddressTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:customerAddressTableName}'
 ...
 CREATE EXTERNAL TABLE ${hiveconf:inventoryTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:inventoryTableName}'
...
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:itemTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:itemTableName}'
...
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:storeSalesTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:storeSalesTableName}'
...
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:storeReturnsTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:storeReturnsTableName}'
...
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:webSalesTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:webSalesTableName}'
...
;
 ...
 CREATE EXTERNAL TABLE ${hiveconf:webReturnsTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:webReturnsTableName}'
...
DROP TABLE IF EXISTS ${hiveconf:reviewsTableName};
 ...
 CREATE EXTERNAL TABLE ${hiveconf:marketPricesTableName}
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:marketPricesTableName}'
...
(   wcs_click_date_sk       bigint
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:clickstreamsTableName}'
...
(   pr_review_sk            bigint              --not null
  ...
  STORED AS PARQUETFILE LOCATION '${hiveconf:hdfsDataPath}/${hiveconf:reviewsTableName}'
